      ...
      <div class="row p-3 border rounded-5 shadow box-area" style="background-color: #f2f2f2;">
        <div class="col-md-6 rounded-4 d-flex flex-column justify-conten-center align-items-center left-box">
          <div class="featured-image mb-1 align-items-center">
            <img src="<?php echo base_url('ViewAssets/') ?>images/1.jpg" alt="image" width="250px" class="image-fluid" />
          </div>
        </div>
        <div class="col-md-6 right-box">
          <div class="row align-items-center cen">
            ...
            <div class="input-group mb-3">
              <input type="text" name="" id="" class="form-control form-control-lg bg-ligth fs-6" placeholder="Kullanıcı Adı" />
            </div>
            <div class="input-group mb-3">
              <input type="password" name="" id="" class="form-control form-control-lg bg-ligth fs-6" placeholder="Şifre" />
            </div>
            <div class="input-group mb-3">
